		...
		<?php 
			...
			<?php if($title != '' || $img_description!= '' || $readmore_button!=''){ ?>
				<div class="container theme-slider-content">
					<div class="theme-text-<?php if('Designexo' == $activate_theme){ echo 'left'; } ?><?php if('Empresa' == $activate_theme){ echo 'center'; } ?> theme-caption-bg<?php if('Empresa' == $activate_theme){ echo '2'; } ?>">
					<?php if($subtitle != ''){ ?>
			...
			<?php if('Designexo' == $activate_theme){ ?>
